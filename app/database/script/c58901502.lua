...
function c58901502.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetMatchingGroupCount(c58901502.filter,tp,LOCATION_MZONE,0,e:GetHandler())>0 end
end
