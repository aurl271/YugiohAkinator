...
function c37474917.cfilter(c)
	return c:IsSetCard(0x43) and c:GetTextAttack()>0
end
function c37474917.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c37474917.cfilter,1,nil) end
	local sg=Duel.SelectReleaseGroup(tp,c37474917.cfilter,1,1,nil)
