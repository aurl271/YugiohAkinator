...
function c25857246.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanDraw(tp,1)
		and Duel.CheckReleaseGroupEx(tp,c25857246.filter,1,REASON_EFFECT,true,nil) end
...
function c25857246.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectReleaseGroupEx(tp,c25857246.filter,1,ct,REASON_EFFECT,true,nil)
