...
function c73694478.filter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x10cf) and Duel.GetMZoneCount(tp,c)>0
...
function c73694478.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c73694478.filter,tp,LOCATION_MZONE,0,1,nil,e,tp) end
