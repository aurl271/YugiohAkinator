...
function c18438874.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b1=Duel.IsExistingMatchingCard(c18438874.cfilter,tp,LOCATION_MZONE,0,1,nil) and Duel.IsPlayerCanDraw(tp,1) and ct>0
	local b2=Duel.IsExistingMatchingCard(c18438874.thfilter1,tp,LOCATION_DECK,0,1,nil) and ct>=4
	local b3=Duel.IsExistingMatchingCard(c18438874.thfilter2,tp,LOCATION_DECK,0,1,nil) and ct>=10
