...
function c67757079.cfilter(c,tp)
	return c:IsFaceup() and c:IsCode(94878265)
		and Duel.GetMZoneCount(tp,c)>0
end
function c67757079.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c67757079.cfilter,1,nil,tp) end
	local g=Duel.SelectReleaseGroup(tp,c67757079.cfilter,1,1,nil,tp)
