...
function c41777.cfilter(c,tp)
	return c:IsSetCard(0x1047) and Duel.GetMZoneCount(tp,c)>0
end
function c41777.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c41777.cfilter,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g=Duel.SelectReleaseGroup(tp,c41777.cfilter,1,1,nil,tp)
