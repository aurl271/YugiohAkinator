...
function c76076738.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and ec and ec:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:CheckEquipTarget(ec) end
...
function c76076738.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)>0 and c:IsRelateToEffect(e) and tc:IsAttribute(ATTRIBUTE_DARK) then
		Duel.Equip(tp,c,tc)
		--Add Equip limit
