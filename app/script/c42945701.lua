...
function c42945701.cfilter(c)
	return c:IsAttribute(ATTRIBUTE_FIRE) and c:GetTextAttack()>0
end
function c42945701.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c42945701.cfilter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c42945701.cfilter,1,1,nil)
