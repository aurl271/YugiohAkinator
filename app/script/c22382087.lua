...
function c22382087.cfilter(c,tp)
	return c:IsSummonType(SUMMON_TYPE_ADVANCE) and c:IsAbleToHandAsCost() and Duel.GetMZoneCount(tp,c)>0
end
function c22382087.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c22382087.cfilter,tp,LOCATION_MZONE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RTOHAND)
	local g=Duel.SelectMatchingCard(tp,c22382087.cfilter,tp,LOCATION_MZONE,0,1,1,nil,tp)
