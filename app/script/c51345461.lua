...
function c51345461.initial_effect(c)
	...
	e2:SetOperation(c51345461.regop)
	c:RegisterEffect(e2)
end
function c51345461.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(51345461,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_BATTLE,0,1)
end
...
function c51345461.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(51345461)~=0 end
