...
function c71340250.costfilter(c,tp)
...
function c71340250.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c71340250.costfilter,1,nil,tp) end
	local sg=Duel.SelectReleaseGroup(tp,c71340250.costfilter,1,1,nil,tp)
