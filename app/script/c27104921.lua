...
function c27104921.initial_effect(c)
	...
	e0:SetDescription(aux.Stringid(27104921,3))
	e0:SetType(EFFECT_TYPE_ACTIVATE)
	e0:SetCode(EVENT_FREE_CHAIN)
	e0:SetCountLimit(1,27104921+EFFECT_COUNT_CODE_OATH)
	c:RegisterEffect(e0)
	--activate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(27104921,4))
	...
	e1:SetCondition(c27104921.condition)
	e1:SetTarget(c27104921.target)
	e1:SetOperation(c27104921.operation)
	c:RegisterEffect(e1)
	--counter
