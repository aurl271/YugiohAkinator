...
function s.retg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and Duel.IsExistingMatchingCard(s.tgfilter,tp,LOCATION_MZONE,0,1,nil,e,tp) and not (Duel.IsPlayerAffectedByEffect(tp,63060238) or Duel.IsPlayerAffectedByEffect(tp,90303176)) end
