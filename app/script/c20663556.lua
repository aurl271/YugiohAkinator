...
function c20663556.cfilter(c,tp)
	return Duel.GetMZoneCount(tp,c)>0
end
function c20663556.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c20663556.cfilter,1,nil,tp) end
	local g=Duel.SelectReleaseGroup(tp,c20663556.cfilter,1,1,nil,tp)
