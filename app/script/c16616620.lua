...
function c16616620.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(c16616620.filter0,tp,LOCATION_MZONE,0,nil)
	if chk==0 then return Duel.GetMZoneCount(tp,g)>0 and g:IsExists(c16616620.filter1,1,nil,e,tp) end
